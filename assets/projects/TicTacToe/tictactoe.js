...
function getAIMove(){
    ...
    else if (boardstring == "-X-XO----") { return 0; } 
    else if (boardstring == "-XO-OXX--") { return 0; } 
    else if (boardstring == "-X-XOOX--") { return 0; } 
    else if (boardstring == "-X--O--X-") { return 0; } 
    else if (boardstring == "-XXXO--O-") { return 0; } 
    ...
    else if (boardstring == "-OX-O-XXO") { return 0; } 
    ...
    else if (boardstring == "---XO---X") { return 1; } 
    ...
    else if (boardstring == "XO-OX-XO-") { return 2; } 
    else if (boardstring == "XO-OX-X-O") { return 2; } 
    else if (boardstring == "X--O-----") { return 2; } 
    else if (boardstring == "XX-OO----") { return 2; } 
    else if (boardstring == "XX--OO---") { return 2; } 
    else if (boardstring == "XX--O-O--") { return 2; } 
    else if (boardstring == "XX--O--O-") { return 2; } 
    else if (boardstring == "XX--O---O") { return 2; } 
    else if (boardstring == "X--OXOX-O") { return 2; } 
    else if (boardstring == "X---O-O-X") { return 2; } 
    else if (boardstring == "X------O-") { return 2; } 
    else if (boardstring == "X--O--X-O") { return 2; } 
    ...
    else if (boardstring == "XX--OX-O-") { return 2; } 
    else if (boardstring == "XO-OOXXX-") { return 2; } 
    else if (boardstring == "XX-XOOOX-") { return 2; } 
    else if (boardstring == "X--XOOOXX") { return 2; } 
    else if (boardstring == "XO-XO-OXX") { return 2; } 
    else if (boardstring == "XO--OXOXX") { return 2; } 
    else if (boardstring == "OX-XO---X") { return 2; } 
    else if (boardstring == "-X--OX---") { return 2; } 
    else if (boardstring == "OX-XO-OXX") { return 2; } 
    else if (boardstring == "OX--OXOXX") { return 2; } 
    else if (boardstring == "-X--O---X") { return 2; } 
    else if (boardstring == "-X-OOX--X") { return 2; } 
    else if (boardstring == "O--XOX--X") { return 2; } 
    else if (boardstring == "-X-XO-OX-") { return 2; } 
    else if (boardstring == "---XOXOX-") { return 2; } 
    ...
    else if (boardstring == "OXOOXXXO-") { return 2; } 
    else if (boardstring == "OX-OX-XO-") { return 2; } 
    ...
    else if (boardstring == "X---OX-XO") { return 2; } 
    ...
    else if (boardstring == "XOO---X--") { return 3; } 
    else if (boardstring == "XO--O-X--") { return 3; } 
    else if (boardstring == "XO---OX--") { return 3; } 
    else if (boardstring == "XO----XO-") { return 3; } 
    else if (boardstring == "XO----X-O") { return 3; } 
    else if (boardstring == "XOO-O-X-X") { return 3; } 
    else if (boardstring == "X-O-OOX-X") { return 3; } 
    else if (boardstring == "X-O-O-XOX") { return 3; } 
    else if (boardstring == "XXO-OOX--") { return 3; } 
    else if (boardstring == "XXO-O-XO-") { return 3; } 
    else if (boardstring == "XXO-O-X-O") { return 3; } 
    else if (boardstring == "X-O--OX--") { return 3; } 
    else if (boardstring == "X---OOX--") { return 3; } 
    else if (boardstring == "X----OXO-") { return 3; } 
    else if (boardstring == "X----OX-O") { return 3; } 
    else if (boardstring == "X-O---X-O") { return 3; } 
    else if (boardstring == "X---O-X-O") { return 3; } 
    else if (boardstring == "X-----XOO") { return 3; } 
    else if (boardstring == "XXO-O-X--") { return 3; } 
    else if (boardstring == "XOX-O--X-") { return 3; } 
    else if (boardstring == "XXO-OXXO-") { return 3; } 
    else if (boardstring == "X---O-X--") { return 3; } 
    else if (boardstring == "XX--OO-X-") { return 3; } 
    else if (boardstring == "X-X-OO-X-") { return 3; } 
    else if (boardstring == "X---OOXX-") { return 3; } 
    else if (boardstring == "X---OO-XX") { return 3; } 
    else if (boardstring == "OXX-OOX-X") { return 3; } 
    else if (boardstring == "OXX-OO-XX") { return 3; } 
    else if (boardstring == "XX--OOX--") { return 3; } 
    else if (boardstring == "-XX-OOX--") { return 3; } 
    else if (boardstring == "-X--OOXX-") { return 3; } 
    ...
    else if (boardstring == "-XO-OXXOX") { return 3; } 
    ...
    else if (boardstring == "XOXO-----") { return 4; } 
    else if (boardstring == "X--O-OX--") { return 4; } 
    else if (boardstring == "XO----O-X") { return 4; } 
    else if (boardstring == "X--O--O-X") { return 4; } 
    else if (boardstring == "X----OO-X") { return 4; } 
    else if (boardstring == "X-----OOX") { return 4; } 
    else if (boardstring == "XOX----O-") { return 4; } 
    ...
    else if (boardstring == "XXOOO-X--") { return 5; } 
    else if (boardstring == "XOX-O-O-X") { return 5; } 
    else if (boardstring == "X-XOO-O-X") { return 5; } 
    else if (boardstring == "X-X-O-OOX") { return 5; } 
    ...
    else if (boardstring == "OXXXO--OX") { return 5; } 
    else if (boardstring == "X-XOO--X-") { return 5; } 
    else if (boardstring == "-XXOO--X-") { return 5; } 
    else if (boardstring == "--XOO-XX-") { return 5; } 
    else if (boardstring == "--XOO--XX") { return 5; } 
    else if (boardstring == "--X-O---X") { return 5; } 
    else if (boardstring == "OX-XO-XOX") { return 5; } 
    else if (boardstring == "O-XXO-OXX") { return 5; } 
    else if (boardstring == "-OXXO-OXX") { return 5; } 
    else if (boardstring == "OXXXX-OO-") { return 5; } 
    ...
    else if (boardstring == "XO-------") { return 6; } 
    else if (boardstring == "X-O-O---X") { return 6; } 
    else if (boardstring == "XOXOXO---") { return 6; } 
    else if (boardstring == "XOXOX---O") { return 6; } 
    else if (boardstring == "XXO-O----") { return 6; } 
    else if (boardstring == "X----O---") { return 6; } 
    else if (boardstring == "XOX-X--OO") { return 6; } 
    else if (boardstring == "X-------O") { return 6; } 
    ...
    else if (boardstring == "XXOXOX-O-") { return 6; } 
    else if (boardstring == "XXO-OX-OX") { return 6; } 
    else if (boardstring == "X--XOO-X-") { return 6; } 
    else if (boardstring == "XO--O--XX") { return 6; } 
    else if (boardstring == "OXOXOX--X") { return 6; } 
    else if (boardstring == "OXOXO--XX") { return 6; } 
    ...
    else if (boardstring == "-OXXOO-XX") { return 6; } 
    else if (boardstring == "---XO--X-") { return 6; } 
    ...
    else if (boardstring == "XXO-OX-XO") { return 6; } 
    else if (boardstring == "X-OXOX-XO") { return 6; } 
    ...
    else if (boardstring == "XXOOOXX-O") { return 7; } 
    ...
    else if (boardstring == "XOXXOO--X") { return 7; } 
    else if (boardstring == "-OXXOOX-X") { return 7; } 
    else if (boardstring == "O--XO-X-X") { return 7; } 
    else if (boardstring == "-OXXO---X") { return 7; } 
    else if (boardstring == "-O-XOX--X") { return 7; } 
    else if (boardstring == "-O-XO-X-X") { return 7; } 
    ...
    else if (boardstring == "XOOOX-X--") { return 8; } 
    else if (boardstring == "XO-OXOX--") { return 8; } 
    else if (boardstring == "X-O------") { return 8; } 
    else if (boardstring == "XOXOX-O--") { return 8; } 
    else if (boardstring == "XOXOX--O-") { return 8; } 
    else if (boardstring == "XXOOOXXO-") { return 8; } 
    else if (boardstring == "X-OOXOX--") { return 8; } 
    else if (boardstring == "X--OXOXO-") { return 8; } 
    else if (boardstring == "X-----O--") { return 8; } 
    else if (boardstring == "XOX-XO-O-") { return 8; } 
    else if (boardstring == "XOX-X-OO-") { return 8; } 
    ...
    else if (boardstring == "OXO-OXXX-") { return 8; } 
    else if (boardstring == "OXXXOOX--") { return 8; } 
    else if (boardstring == "OX-XOOXX-") { return 8; } 
    else if (boardstring == "OX--OX-X-") { return 8; } 
    else if (boardstring == "OX--O-XX-") { return 8; } 
    else if (boardstring == "XOXOOX-X-") { return 8; } 
    else if (boardstring == "OXXXOX-O-") { return 8; } 
    else if (boardstring == "OXXXO-XO-") { return 8; } 
    ...
    else if (boardstring == "OXXXO-OX-") { return 8; } 
    else if (boardstring == "O-XXOXOX-") { return 8; } 
    else if (boardstring == "-O--OXXX-") { return 8; } 
    else if (boardstring == "----OX-X-") { return 8; } 
